...
class QuickpathAdapter(private val onPathClickListener: (File) -> Unit) :
    ListAdapter<String, QuickpathAdapter.ViewHolder>(StringDiffCallback) {
    //TODO fix user submited list, only allow submitpath
    private var path = File("")

    class ViewHolder(itemViewBinding: ItemQuickpathBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemQuickpathBinding.inflate(LayoutInflater.from(parent.context), parent, false)
