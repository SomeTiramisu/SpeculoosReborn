...
class MangaCardAdapter(
    ...
    private val onCardClickListener: (Uri) -> Unit
) : ListAdapter<Item, MangaCardAdapter.ViewHolder>(MangaDiffCallback) {

    class ViewHolder(itemViewBinding: ItemMangaCardBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemMangaCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
